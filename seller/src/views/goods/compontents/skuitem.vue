    ...
    >
      ...
      <table class="stock-table">
        ...
        <tbody>
          ...
          >
            <td
              v-for="(value, specIndex) in item.sp_value"
			  v-if="item.sp_value&&item.sp_value.length>0"
              :key="specIndex"
            >
              {{ value }}
            </td>
            ...
            <td>
              <a-input type="number" v-model="item.stock" />
            </td>
            <!-- <td>
              <a-input type="number" v-model="childProductArray[index].alarm" />
            </td> -->
            <!-- <td style="width:60px">
              <a-input v-model="item.sku" />
            </td>
            <td style="width:60px">
              <a-input v-model="item.barcode" />
            </td> -->
          </tr>
        </tbody>
      </table>
...
export default {
  computed: {
	...
	dataList(){
		return this.goodItemSku.sku
	},
	specList(){
		return this.goodItemSku.spec_name
	}
  },
  data() {
    return {
