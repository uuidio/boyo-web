<template>
  <div class="content ">
    ...
    <div class="editHome">
      ...
      <div class="edit_Box" v-if="items.edit&&visible">
...
import { Swipers, editSwipers, GrapNav, editGrapNav, goodGroup, editgoodGroup, CustomImg, editCustomImg, Title, editTitle, editGoodSwiper, GoodSwiper, editSlideNav, SlideNav,ActivityGroup,editActivityGroup,editTetris,Tetris,editSpecial,Special,
GroupTemp,editGroupTemp} from '../shopConfig/shopConfig';
