      ...
      <a-form :label-width="80">
        ...
        <div v-if="type === 'show_image'">
          ...
          <a-form-item label="展示数据" v-if="show_type !== 'coupon' && show_type !=='integral' && show_type !== 'group'">
            <div v-if="show_type === 'class'"><a-cascader v-model="selectClass" :options="classTree" @change="selectClassChange" placeholder="请选择分类" changeOnSelect/></div>
            ...
            <div v-if="show_type === 'customActivity'">
              <span v-if="value">自定义活动ID：{{value}}</span>
        ...
        <div v-if="isGoodsSwiper && !hotGoods">
          ...
          <div>
            <a-cascader v-if="toType === 'class'" v-model="allClass" :options="classTree" @change="classChange" placeholder="请选择分类" changeOnSelect/>
