...
export default {
  computed: {
    ...mapState({
      listsData: state => state.trade.refundsGoodData,
      pages: state => state.trade.refundsGoodPages,
	  listField: state => state.trade.refundsGoodFields,
  ...
  methods: {
    ...mapActions({
      fetchLists: "trade/refundsGoodLists",
	  exportFilter: "trade/exportRefundsGood",
    ...
    filterOk() {
      this.isFillter = true;
      this.currentAct = this.exportForm.status?this.exportForm.status:'';
