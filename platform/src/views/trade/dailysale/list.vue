  ...
  <div class="content">
    ...
    <a-modal :title="title" v-model="exportModel" @ok="filterOk" @cancel="filterCancel">
      ...
      <a-form-item
        ...
        :wrapper-col="{ md: 18, xs: 24 }"
      >
       <a-date-picker @change="onChange" v-if="timeVisible">
    	</a-date-picker>
      </a-form-item>
    </a-modal>
  </div>
...
export default {
  computed: {
    ...mapState({
      listsData: state => state.trade.dailysaleData,
      pages: state => state.trade.dailysalePages,
	  listField: state => state.trade.dailysaleFields,
  ...
  methods: {
    ...mapActions({
      fetchLists: "trade/dailysaleList",
	  exportFilter: "trade/exportDailysale",
	...
	// },
	filterCancel(){
		this.exportForm.filter_time=''
	},
	onChange(value, dateString) {
			console.log('Formatted Selected Time: ', dateString);
			this.exportForm.filter_time = dateString;
		},
		timeOk(value) {
