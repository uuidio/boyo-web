...
export default {
  computed: {
    ...mapState({
      listsData: state => state.trade.goodCostData,
      pages: state => state.trade.goodCostPages,
	  listField: state => state.trade.goodCostFields,
  ...
  methods: {
    ...mapActions({
      fetchLists: "trade/goodCostList",
	  exportFilter: "trade/exportgoodCost",
	  goodCostDown:'trade/goodCostDown',
	...
	dataHandleOk(){
		...
		this.goodCostDown({exportForm:this.exportForm,callback:this.excelBack});
		setTimeout(()=>{
