  ...
  <div class="shop_list">
    ...
    <div class="add_shop">
      ...
      <draggable :options="sortOptions" v-model="dataLists" class="goodsBox" >
        <div v-for="(goodsItem,index) in dataLists" :key="index" class="selectGoods">
    ...
    <div class="list_item_style">
      ...
      <a-radio-group name="radioGroup" v-model="showConfig.list_num"  @change="changeCheck">
        ...
        <a-radio :value="6" :style="style">横向滑动</a-radio><!-- style2 -->
      </a-radio-group>
    </div>
    <div class="list_item_style" v-if="showConfig.list_num==6">
      <span>查看更多跳转地址:</span>
      <urlSelect :fit_up="showConfig.isFitUp" @on-change="getChangeItem" :url_type="showConfig.urlType" :init_value="showConfig.value" >
    ...
    <div class="mt20">
      <div class="mb10">上圆角：</div>
      <div>
        <a-slider :min="0"  v-model="showConfig.tR" />
      </div>
    </div>
    <div class="mt20">
      <div class="mb10">下圆角：</div>
      <div>
        <a-slider :min="0"  v-model="showConfig.bR" />
      </div>
    </div>
    <div class="mt20">
      <div class="mb10">列表项圆角：</div>
      <div>
        <a-slider :min="0"  v-model="showConfig.itemR" />
      </div>
    </div>
  </div>
</template>
