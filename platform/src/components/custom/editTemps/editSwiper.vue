          ...
          <draggable :options="sortOptions" v-model="showItem">
            <li :key="index" v-for="(item,index) in showItem" class="swiperItem">
              ...
              <div class="swiper_txt">
                ...
                <div>
                  <span>跳转路径</span>
                  <urlSelect :fit_up="config.isFitUp" :url_type="item.urlType" :init_value="item.value" @on-change="getChangeItem">
...
<!--            <a href="javascript:void(0);" style="color: #38f;text-decoration: none;cursor: pointer;margin-left:10px" @click="backBackColor">重置</a>-->
          </div>
        </div>
      </div>
    </div>
