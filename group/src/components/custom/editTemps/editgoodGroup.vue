    ...
    <div class="shop_list">
      ...
      <div class="add_shop">
        ...
        <div class="list_item_style" v-if="showConfig.list_num==6">
          <span>查看更多跳转地址:</span>
          <urlSelect @on-change="getChangeItem" :url_type="showConfig.urlType" :init_value="showConfig.value" >
...
export default {
    ...
    computed: {
      shop_list(){
        ...
        }else if(this.editType==='equity'){
          return this.$store.state.custom.equityItems
        }
      },
      showConfig(){
