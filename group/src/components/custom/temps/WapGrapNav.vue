<template>
  <div>
    <div v-if="dataLists.length>0" :class="config.list_num==6?'over_flow':''">
      <ul class="nav-ul" :style="{margin:config.mT+'px'+' '+ config.mL+'px','borderRadius':config.r+'px','padding':config.p+'px','background':config.background}">
