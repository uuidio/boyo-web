<template>
  <div>
    <div :style="{
      ...
      <div v-if="config.imgType === 'IP'" class="imgIP fxBox2">
         <span class="hotSpan">IP故事</span>
        <span class="col-666 fs12">更多></span>
      </div>
    ...
    'levelthree':config.list_num===3?true:false
        ...
        <div class="imgBox" v-for="(item,index) in dataLists">
