...
/***/ 1037:
/*!****************************************************************************************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/node_modules/_@dcloudio_uni-ui@1.2.5@@dcloudio/uni-ui/lib/uni-popup/popup.js ***!
  \****************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _message = _interopRequireDefault(__webpack_require__(/*! ./message.js */ 1038));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 1038:
/*!******************************************************************************************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/node_modules/_@dcloudio_uni-ui@1.2.5@@dcloudio/uni-ui/lib/uni-popup/message.js ***!
  \******************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 12:
/*!*********************************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/static/base/config.js ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {var _vueUtil = _interopRequireDefault(__webpack_require__(/*! ./vueUtil */ 5));
var _http = __webpack_require__(/*! ./http */ 13);
var _util = __webpack_require__(/*! ./util.js */ 15);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
var request = new _http.HTTP();

_vueUtil.default.prototype.$http = function (params) {
  return request.request(params);
};

_vueUtil.default.prototype.needTokenLink = function (link) {
...
_vueUtil.default.prototype.customTo = function (item, gm_id) {
  switch (item.urlType) {
    case 'goods':
      uni.navigateTo({
    ...
    case 'class':
      if (item.level === 2) {
        ...
        _vueUtil.default.prototype.firstClassID = item.value[0];
        uni.switchTab({
...
_vueUtil.default.prototype.DevelopmentTips = function (msg, url) {
  uni.showModal({
    title: '温馨提示',
    content: '该功能升级中，敬请期待',
    showCancel: false,
...
_vueUtil.default.prototype.RefuseBrowse = function (msg, url) {
  uni.showModal({
    title: '温馨提示',
    content: msg,
...
_vueUtil.default.prototype.resetFirstClassID = function (val) {
  _vueUtil.default.prototype.firstClassID = val;
};
_vueUtil.default.prototype.toLink = function (link) {
  uni.navigateTo({
    url: link });

};
_vueUtil.default.prototype.toGoodsDetail = function (id) {
  uni.navigateTo({
    url: '/pagesA/goods/detail?id=' + id });

};
_vueUtil.default.prototype.toQueryLink = function (link, obj) {
  var query = (0, _util.getParams)(obj);
  uni.navigateTo({
    url: link + '?' + query });

},

_vueUtil.default.prototype.needTokenQueryLink = function (link, obj) {
  var token = uni.getStorageSync('user_token');
  if (!token) {
    uni.navigateTo({
      url: '/pagesA/user/bindUser' });
...
_vueUtil.default.prototype.getPage = function () {
  var pages = getCurrentPages();
  var prePage = pages[pages.length - 2];
  return prePage.$vm;
};
_vueUtil.default.prototype.redirectToLink = function (link, obj) {
  if (obj) {
    var query = (0, _util.getParams)(obj);
    uni.redirectTo({
      url: link + '?' + query });
...
_vueUtil.default.prototype.toBack = function (router) {
  if (router === 'cart') {
    uni.switchTab({
...
_vueUtil.default.prototype.choiceBack = function (delta) {
  uni.navigateBack({
    delta: delta || 1 });

};
_vueUtil.default.prototype.toNav = function (link) {
  uni.switchTab({
    url: link });

};
_vueUtil.default.prototype.showAlert = function (content) {
  uni.showToast({
    title: content,
    icon: 'none' });

};
_vueUtil.default.prototype.walletLocking = function (time, goBack) {// 钱包锁定
  uni.showModal({
    title: '钱包功能已被锁定',
...
/***/ 1221:
/*!********************************************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/wxcomponents/vant/popup/index.js ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
var _component = __webpack_require__(/*! ../common/component */ 1222);
var _transition = __webpack_require__(/*! ../mixins/transition */ 1224);
...
/***/ 1222:
/*!*************************************************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/wxcomponents/vant/common/component.js ***!
  \*************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.VantComponent = VantComponent;var _basic = __webpack_require__(/*! ../mixins/basic */ 1223);function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
/***/ 1223:
/*!*********************************************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/wxcomponents/vant/mixins/basic.js ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 1224:
/*!**************************************************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/wxcomponents/vant/mixins/transition.js ***!
  \**************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.transition = void 0;var _utils = __webpack_require__(/*! ../common/utils */ 1225);
...
/***/ 1225:
/*!*********************************************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/wxcomponents/vant/common/utils.js ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 13:
/*!*******************************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/static/base/http.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.HTTP = void 0;var _server = __webpack_require__(/*! ./server2.js */ 14);
...
HTTP = /*#__PURE__*/function () {function HTTP() {_classCallCheck(this, HTTP);}_createClass(HTTP, [{ key: "request", value: function request(_ref)
    ...
    {var _this = this;var url = _ref.url,aurl = _ref.aurl,aPath = _ref.aPath,params = _ref.params,_success = _ref.success,_fail = _ref.fail,_complete = _ref.complete,_ref$data = _ref.data,data = _ref$data === void 0 ? {} : _ref$data,_ref$header = _ref.header,header = _ref$header === void 0 ? {} : _ref$header,_ref$needToken = _ref.needToken,needToken = _ref$needToken === void 0 ? false : _ref$needToken,_ref$needErrTips = _ref.needErrTips,needErrTips = _ref$needErrTips === void 0 ? true : _ref$needErrTips;
      if (aurl != undefined) {
        needToken = _server.config.apiLinks[aurl].needToken;
      }
      ...
      if (needToken) {
        try {
          ...
          _server.config.header.Authorization = 'Bearer ' + tempToken || false;
          if (!tempToken) {
            uni.navigateTo({
              url: '/pagesA/user/bindUser' });
      ...
      _server.config.header.GmToken = gmToken || 1;
      var tempUrl = url;
      var tempType = null;
      if (aurl != undefined) {
        if (_server.config.apiLinks[aurl]) {
          tempUrl = aPath ? _server.config.apiLinks[aurl].url + "/" + (0, _util.creatPathStr)(aPath) : _server.config.apiLinks[aurl].url;
          if (params) {
            tempUrl = tempUrl + "?" + (0, _util.getParams)(params);
          }
          tempType = _server.config.apiLinks[aurl].type;
        }
      }
      if (!tempUrl) {
        uni.showToast({
      ...
      uni.request({
        ...
        url: regex.test(tempUrl) ? tempUrl : _server.config.api_base_url + tempUrl,
        method: tempType || 'GET',
        data: data,
        header: Object.assign(header, _server.config.header),
        success: function success(res) {
          var code = res.statusCode.toString();
          if (res.data.code === 0) {
            _success && _success(res);
          } else if (res.data.code === 401) {
            var tempTokenJump = uni.getStorageSync('user_token_jump');
            var jump = tempTokenJump || 0;
            if (jump > 0) {
              return;
            }
            uni.removeStorage({
            ...
            if (res.data.result.errors) {
              var errors = res.data.result.errors;
              var text = '';
              for (var key in errors) {
                text = errors[key];
                break;
              }
              _this._show_error(text);
            } else {
              if (needErrTips) {
                _this._show_error(res.data.message);
              }
            }
          }
        ...
        fail: function fail(err) {
          _fail && _fail(err);
          _this._show_error(JSON.stringify(err));
        },
  ...
  }, { key: "_show_error", value: function _show_error(msg) {
      uni.showToast({
        title: msg,
        icon: 'none' });
...
/***/ 14:
/*!**********************************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/static/base/server2.js ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.config = void 0;var config = {
  ...
  header: {
    Accept: 'application/json' } };exports.config = config;

/***/ }),

/***/ 15:
/*!*******************************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/static/base/util.js ***!
  \*******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.creatPathStr = creatPathStr;exports.getParams = getParams;exports.getSubscribe = getSubscribe;exports.showTuisong = showTuisong;var _vueUtil = _interopRequireDefault(__webpack_require__(/*! ./vueUtil */ 5));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

function creatPathStr(arr) {var delimit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "/";
  ...
  uni.getSetting({
    ...
    success: function success(res) {
      if (res.subscriptionsSetting && res.subscriptionsSetting.itemSettings) {
        var setItems = res.subscriptionsSetting.itemSettings;
        for (var i = 0; i < temids.length; i++) {
          var key = temids[i];
      ...
      uni.requestSubscribeMessage({
        ...
        success: function success(res) {
          var arr = [];
          for (var _i = 0; _i < temids.length; _i++) {
            var _key = temids[_i];
            if (res[_key] == 'accept') {
              arr.push(setids[_i]);
            }
...
/***/ 16:
/*!**********************************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/static/mta_analysis.js ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

var MTA_CONFIG = { app_id: "", event_id: "", api_base: "https://pingtas.qq.com/pingd", prefix: "_mta_", version: "1.3.10", stat_share_app: !1, stat_pull_down_fresh: !1, stat_reach_bottom: !1, stat_param: !0 };function getNetworkType(a) {wx.getNetworkType({ success: function success(b) {a(b.networkType);} });}
...
var MTA = { App: { init: function init(a) {"appID" in a && (MTA_CONFIG.app_id = a.appID);"eventID" in a && (MTA_CONFIG.event_id = a.eventID);"statShareApp" in a && (MTA_CONFIG.stat_share_app = a.statShareApp);"statPullDownFresh" in a && (MTA_CONFIG.stat_pull_down_fresh = a.statPullDownFresh);"statReachBottom" in a && (MTA_CONFIG.stat_reach_bottom = a.statReachBottom);"ignoreParams" in a && (MTA_CONFIG.ignore_params = a.ignoreParams);"statParam" in a && (MTA_CONFIG.stat_param = a.statParam);setSID();try {"lauchOpts" in a && (MTA.Data.lanchInfo = a.lauchOpts,
      ...
      !function () {var b = a.onPullDownRefresh;a.onPullDownRefresh = function () {MTA.Event.stat(MTA_CONFIG.prefix + "pulldownfresh", { url: a.__route__ });b.apply(this, arguments);};}();MTA_CONFIG.stat_reach_bottom && a.onReachBottom && !function () {var b = a.onReachBottom;a.onReachBottom = function () {MTA.Event.stat(MTA_CONFIG.prefix + "reachbottom", { url: a.__route__ });b.apply(this, arguments);};}();MTA_CONFIG.stat_share_app && a.onShareAppMessage && !function () {var b = a.onShareAppMessage;a.onShareAppMessage = function () {MTA.Event.stat(MTA_CONFIG.prefix +
          "shareapp", { url: a.__route__ });return b.apply(this, arguments);};}();}, multiStat: function multiStat(a, b) {if (1 == b) MTA.Page.stat(a), !0;else {var c = getCurrentPages()[getCurrentPages().length - 1];c.onShow && !function () {var b = c.onShow;c.onShow = function () {MTA.Page.stat(a);b.call(this, arguments);};}();}}, stat: function stat(a) {if ("" != MTA_CONFIG.app_id) {var b = [],c = getExtentInfo();a && (c.r2 = a);a = [getMainInfo(), c, getBasicInfo()];if (MTA.Data.lanchInfo) {a.push({ ht: MTA.Data.lanchInfo.scene });MTA.Data.pageQuery && MTA.Data.pageQuery._mta_ref_id &&
...
/***/ 161:
/*!*************************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/mock/goods.js ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  goodsLists: [{
    cover: 'https://lanlnk-dev.oss-cn-shenzhen.aliyuncs.com/images/mall/product/1.jpg',
  ...
  {
    cover: 'https://lanlnk-dev.oss-cn-shenzhen.aliyuncs.com/images/mall/product/2.jpg',
  ...
  {
    cover: 'https://lanlnk-dev.oss-cn-shenzhen.aliyuncs.com/images/mall/product/3.jpg',
    title: '【第2支1元】柔色尽情丝柔口红唇膏女士不易掉色保湿滋润防水 珊瑚红',
    price: 299,
    market_price: 699,
    sold: 666 },

  {
    cover: 'https://lanlnk-dev.oss-cn-shenzhen.aliyuncs.com/images/mall/product/4.jpg',
    title: '百雀羚套装女补水保湿护肤品',
    price: 1599,
    market_price: 2899,
    sold: 236 },
  ...
  {
    cover: 'https://lanlnk-dev.oss-cn-shenzhen.aliyuncs.com/images/mall/product/5.jpg',
  ...
  {
    cover: 'https://lanlnk-dev.oss-cn-shenzhen.aliyuncs.com/images/mall/product/6.jpg',
    title: '短袖睡衣女夏季薄款休闲家居服短裤套装女可爱韩版清新学生两件套 短袖粉色长颈鹿 M码75-95斤',
    price: 599,
    market_price: 899,
    sold: 2399 },
  ...
  goodsDetail: {
    images: [
    {
      src: 'https://m.360buyimg.com/mobilecms/s750x750_jfs/t1/35363/20/7488/150225/5cc7ecf0E9442ef4c/23de7c608ba33d36.jpg!q80.dpg' },

    {
      src: 'https://m.360buyimg.com/mobilecms/s843x843_jfs/t26278/132/464739398/149005/7969cf69/5baee95bN55700c8f.jpg!q70.dpg.webp' },

    {
      src: 'https://m.360buyimg.com/mobilecms/s750x750_jfs/t1/3075/32/7264/265054/5ba5c139E282490c6/4d706ecdbd72ed94.jpg!q80.dpg.webp' },

    {
      src: 'https://m.360buyimg.com/mobilecms/s843x843_jfs/t27601/339/454707100/149005/7969cf69/5baee95eN87799284.jpg!q70.dpg.webp' },

    {
      src: 'https://m.360buyimg.com/mobilecms/s750x750_jfs/t1/3075/32/7264/265054/5ba5c139E282490c6/4d706ecdbd72ed94.jpg!q80.dpg.webp' }],


    content: '<div style="text-align:center;"><img width="100%" src="https://s2.ax1x.com/2019/03/28/AdOogx.jpg"/><img width="100%" src="https://s2.ax1x.com/2019/03/28/AdOHKK.jpg"/><img width="100%" src="https://s2.ax1x.com/2019/03/28/AdOTv6.jpg"/></div>' } };exports.default = _default;
...
/***/ 23:
/*!******************************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/mixins/redirect.js ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 24:
/*!****************************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/mixins/global.js ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _server = __webpack_require__(/*! ../static/base/server2.js */ 14);var _default =
...

{
  ...
  methods: {
    getUserSetting: function getUserSetting(link) {
      var _this = this;
      var token = uni.getStorageSync('user_token');
      uni.getSetting({
      ...
      if (e.detail.errMsg === 'getPhoneNumber:ok') {
        ...
        uni.login({
          ...
          success: function success(loginRes) {var _this2 = this;
            ...
            uni.request({
              url: _server.config.api_base_url + _server.config.apiLinks.bindUser.url, //仅为示例，并非真实接口地址。
              data: {
                code: loginRes.code,
                iv: encodeURIComponent(e.detail.iv),
                encryptedData: encodeURIComponent(e.detail.encryptedData) },
              ...
              fail: function fail(e) {
                _this2.showAlert(JSON.stringify(e));
                console.log(e);
              } });
    ...
    userLogin: function userLogin() {
      uni.login({
        ...
        success: function success(loginRes) {
          uni.request({
            url: _server.config.api_base_url + _server.config.apiLinks.userLogin.url + loginRes.code, //仅为示例，并非真实接口地址。
            method: 'get',
            success: function success(res) {
              if (res.data.result.user_info) {
                res.data.result.user_info.avatarUrl = res.data.result.user_info.headimgurl;
  ...
  onLoad: function onLoad(options) {var _this3 = this;
    ...
    uni.getSystemInfo({
      success: function success(res) {
        _this3.myWidth = obj.left || res.windowWidth;
        _this3.myRight = obj.width + 10 || 0;
        _this3.myHeight = obj.top ? obj.top + obj.height + 6 : res.statusBarHeight + 44;
        _this3.myTop = obj.top ? obj.top + (obj.height - 32) / 2 : res.statusBarHeight + 6;
        _this3.guidePopupTop = parseFloat(_this3.myHeight) + parseFloat(_this3.myTop) + 3;
        var menuButtonInfo = uni.getMenuButtonBoundingClientRect();
        _this3.guidePopupRight = res.windowWidth - menuButtonInfo.right - 15;
        _this3.guideTriangleRight = _this3.guidePopupRight + menuButtonInfo.width / 2 + menuButtonInfo.width / 4 - 4;
      } });
...
/***/ 25:
/*!*****************************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/mixins/cartNum.js ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 362:
/*!*************************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/mock/order.js ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  orderLists: [
  {
    tid: '30190826143539910693',
    shop_info: {
      shop_name: '施华洛世奇专卖店',
      shop_logo: "http://img.hyplmm.com/images/default/201908/06/jhZVx8M5GIh8VEEcf0nlWGF6GvCcXTCKuF4kQFbv.jpeg" },
    ...
    trade_order: [{
      ...
      tid: '30190826143539910693',
      total_fee: '380.00',
      goods_image: "http://img.hyplmm.com/images/default/201908/19/ObNqCQcOtsFMx85Oc4ACcyUCvSST3rufJtaSV9xW.jpeg",
      goods_name: "Swarovski 施华洛世奇项链 大小号时尚天鹅系列吊坠 送女友礼物 玫瑰金链大黑天鹅",
      goods_id: 374071 }] }] };exports.default = _default;

/***/ }),

/***/ 4:
/*!**********************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/pages.json ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 48:
/*!*************************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/mixins/mta.js ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _mta_analysis = _interopRequireDefault(__webpack_require__(/*! ../static/mta_analysis.js */ 16));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  data: function data() {
    return {};
  ...
  onLoad: function onLoad(options) {
    _mta_analysis.default.Page.init();
  },
  mounted: function mounted() {
  } };exports.default = _default;
...
/***/ 5:
/*!**********************************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/static/base/vueUtil.js ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 65:
/*!****************************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/mixins/wallet.js ***!
  \****************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  methods: {
    hasPayPassword: function hasPayPassword() {
      var that = this;
      this.$http({
        aurl: 'hasPayPassword',
        success: function success(res) {
...
/***/ 66:
/*!**********************************************************************************!*\
  !*** /Users/huangdahao/Desktop/web/smartconns_go/miniapp/static/base/toolFun.js ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  toFullTime: function toFullTime() {
    /*返回yyyy-mm-dd hh:mm:ss 时间格式*/var _ref =
  ...
  toTimeStamp: function toTimeStamp(yymmdd) {
