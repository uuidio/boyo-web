const config = {
	...
	api_base_url: 'https://api.boyo.tv/shop/', //播丫GO正式
	img_base_url: 'https://api.boyo.tv/images/', //益购测试(图片地址)
	...
	api_h5_url:'https://api.boyo.tv/admin/platform/',//h5view正式

	apiLinks: {
		wechatminipay: {
			// url: 'https://api-dev.boyo.tv/payment/wechatminipay', //益购测试
			url: 'https://api.boyo.tv/payment/wechatminipay', //益购正式
