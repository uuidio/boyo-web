<template>
	<view class="addCheckoutAdd">
		...
		<view class="border-radius5px fxBox2 p-md bc-fff">
			...
			<van-switch :checked="formItem.is_default === 0 ? false : true" active-color="#07c160" size="16px" @change="getSwitch" />
		</view>
		<view class="submit-add text-md" @click="saveAddress">保存地址</view>
		<van-popup :show="showSelect" position="bottom"><van-area :area-list="chinaArea" @confirm="getArea" @cancel="cancelShow" /></van-popup>
	</view>
</template>
