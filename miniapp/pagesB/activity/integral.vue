...
<!--				   <img src="../../static/images/logo.png"/>-->
			   ...
			   <view class="integral_info">
				   <view class="me_integral">我的积分：<text class="span">{{myPoint}}</text></view>
...
export default {
  mixins: [mta],
	...
	gotoRecord(){
		uni.navigateTo({
			url: '/pagesB/activity/exchangeRecord?selectIndex=0'
		});
	},
	gotoCoinExchange(){
			 uni.navigateTo({
