    ...
    <view  v-if="show">
      <view class="p-md m-md bc-fff border-radius5px">
        <view class="mb-md fxBox">
          推广员姓名：{{detail.real_name}}
        </view>
        <view class="mb-md fxBox">
          推广员手机号：{{detail.mobile}}
        </view>
        <view class="mb-md fxBox">
          审核状态：{{getStatusText}}
        </view>
        ...
        <view v-if="detail.register_type=='per'">
          <view class="mb-md fxBox">
            推广员工号：{{detail.job_number}}
          </view>
          <view class="fxBox">
            推广员工牌：<view class="fx1"><image mode="widthFix" style="width:70%" :src="detail.department"></image></view>
          </view>
        </view>
        <view v-else-if="detail.register_type=='pt'">
          <view class="mb-md fxBox">
          ...
          <view class="mb-md fxBox">
            推荐人手机号：{{detail.partner_mobile}}
          </view>
          <!--<view class="mb-md fxBox">-->
          <!--身份证正面：<view class="fx1"><image v-if="detail.photo" mode="widthFix" style="width:70%" :src="detail.photo.p"></image></view>-->
          <!--</view>-->
          <!--<view class="fxBox">-->
          <!--身份证反面：<view class="fx1"><image v-if="detail.photo" mode="widthFix" style="width:70%" :src="detail.photo.o"></image></view>-->
          <!--</view>-->
        </view>
      </view>
