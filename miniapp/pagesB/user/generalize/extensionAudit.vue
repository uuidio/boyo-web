        ...
        <view v-for="(item,index) in lists" class="p-md mt-md fxBox bc-fff lists-item fxBox border-radius5px">
          ...
          <view class="lists-text fx1">
            <view class="w100 fxBox2">
              ...
              <view class="seeDetailBtn" v-if="item.apply_status=='apply'" @tap="needTokenQueryLink('/pagesB/user/generalize/extensionAuditDetail',{id:item.id})">去审核</view>
              <view v-else class="seeDetailBtn" @tap="needTokenQueryLink('/pagesB/user/generalize/extensionAuditDetail',{id:item.id})">查看详情</view>
            </view>
            <view class="col-666">
