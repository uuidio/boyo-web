        ...
        <!--<view class="earnings">-->
          <!--<view class="top pb-md">-->
            <!--<view class="fxBox2">-->
              ...
              <!--</view>-->
              <!--<view class="fxBox1">-->
                <!--<view @tap="needTokenLink('/pagesB/user/generalize/depositLists')">查看历史数据</view>-->
              <!--</view>-->
            <!--</view>-->
            <!--<view>-->
          ...
          <!--<view class="bottom fxBox1 pt-md">-->
            <!--<view class="fx1" @tap="needTokenLink('/pagesB/user/generalize/myStore')">-->
              ...
              <!--</view>-->
            <!--</view>-->
            <!--<view class="fx1" @tap="needTokenQueryLink('/pagesB/user/generalize/myAgent')">-->
              <!--<view class="col-999 text-sm">-->
                <!--店家推广员（人）-->
              <!--</view>-->
              <!--<view class="fw700 text-18 mt-xs" >-->
      ...
      <!--<view class="m-lg border-radius5px bc-fff">-->
        ...
        <!--<view class="p-md tabs">-->
          ...
          <!--<view class="mt-lg">-->
            <!--<view class="fxBox1">-->
              <!--<view class="fx1">-->
                <!--<view class="col-999 text-sm">销售额（元）</view>-->
        ...
        <!--</view>-->
      <!--</view>-->
      <view class="bc-fff distr-margin m-lg p-md border-radius5px fxBox1 col-base text-center">
        <view class="partner-item" @tap="toCode">
          <view class="text-icon">
            <text class="emfont icon-friend_add_light text-18"></text>
          </view>
          <view>
            <text class="text-sm">邀请小店</text>
          </view>
        </view>
        <view class="partner-item" @tap="needTokenLink('/pagesB/user/generalize/storeAudit')">
          <view class="text-icon">
            <text class="emfont icon-searchlist text-18"></text>
          </view>
          <view>
            <text class="text-sm">小店审核</text>
          </view>
        </view>
      </view>
    </view>
          ...
          success: res => {
            if(res.data.code==0){
              if(res.data.result.pt_wx_mini_qr){
                this.needTokenLink('/pagesB/user/generalize/distributorCode')
              }else{
